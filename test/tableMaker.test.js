...
test("constructRowMultipleData", () => {
  let expectedRow =
    '<tr><th scope="row">label</th><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td></tr>';
...
describe("tests using common header/row", () => {
  ...
  beforeEach(() => {
    headerRow =
      '<tr><th scope="col">header1</th><th scope="col">header2</th><th scope="col">header3</th><th scope="col">header4</th><th scope="col">header5</th></tr>';
    singleRowArr = [
      '<tr><th scope="row">label</th><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td></tr>',
    ];
  });
